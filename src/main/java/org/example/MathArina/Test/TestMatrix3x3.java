...
import org.example.MathArina.Matrix.Matrix3x3;
...
public class TestMatrix3x3 {
    ...
    public void testPlus() {
        ...
        for (int i = 0; i < 3; i++){
            for (int j = 0; i < 3; i++) {
                assertEquals(expected.elements()[i][j], result.elements()[i][j], 0.001);
            }
        }
    }
    ...
    public void testIdentity() {
        ...
        float[][] actualData = identity.elements();
    ...
    public void testZeroMatrix() {
        ...
        float[][] actualData = zero.elements();
        assertArrayEquals(expectedData, actualData);
    }
